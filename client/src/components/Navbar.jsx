  ...
  return (
    ...
    {menuLinks.map((link,index)=>(
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
            ...
            <button onClick={ ()=> setShowLogin(true)}className="cursor-pointer" px-8 py-2 bg-primary hover:bg-primrry-dull transition-all text-white rounded-lg>Login</button>
        </div>
    </div>
